...
const Header = props => {
  ...
  const [menuShowing, setMenuShowing] = useState(props.history.location.pathname === '/quizzes')
  ...
  useEffect(() => {
    if (props.history.location.pathname === '/quizzes') {
      ...
      window.addEventListener('scroll', () =>
        listenScrollEvent(setMenuShowing, props.history.location.pathname === '/quizzes')
      )
    } else {
      setMenuShowing(false)
